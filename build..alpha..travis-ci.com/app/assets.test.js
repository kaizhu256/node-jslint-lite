 ...
 */
    ...
    [
        ...
        "/*jslint for*/\nfunction aa(){for (0 in bb){}}",
        "0=0",
        "const aa=0;for(aa in bb){}",
        ...
        "function aa(){while (true) {aa.map(()=>0);}}",
        ...
        "function aa(){try{return;}catch(ignore){}finally{switch(0){case 0:}}}",
        "function aa(){while(true){continue;}}",
        "function aa(){while(true){try{0;}catch(ignore){}finally{continue;}}}",
        ...
        "__unreachable_a__",
        "function aa(){while(true){break;0;}}",
